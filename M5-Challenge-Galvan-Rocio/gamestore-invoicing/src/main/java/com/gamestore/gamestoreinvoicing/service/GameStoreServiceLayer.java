package com.gamestore.gamestoreinvoicing.service;

import com.gamestore.gamestoreinvoicing.model.*;
import com.gamestore.gamestoreinvoicing.repository.InvoiceRepository;
import com.gamestore.gamestoreinvoicing.repository.ProcessingFeeRepository;
import com.gamestore.gamestoreinvoicing.repository.TaxRepository;
import com.gamestore.gamestoreinvoicing.util.feign.GameStoreCatalogClient;
import com.gamestore.gamestoreinvoicing.viewModel.InvoiceViewModel;
...
// referenced video from office hours on Nov. 2nd when Dan helped Tri
@Component
//@Service
...
//    added feign client
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            Console tempCon = null;  // you don't necessarily need this
//            removed optional since we will only get 1 console not a list
...
//            original:
//            Console returnVal = client.getConsole(invoiceViewModel.getItemId());
            tempCon = returnVal;  // you don't necessarily need this- :39 11/2 after class video
        ...
        if (returnVal2.isPresent()) {
            ...
            throw new IllegalArgumentException("processingFee item is unavailable.");
        }
